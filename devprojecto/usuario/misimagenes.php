...
// Consulta las imagenes del usuario
$imagenes = $mysqli->query("SELECT IMAGENES.*, USUARIOS.id AS id_usuario, USUARIOS.nombre, USUARIOS.nick, USUARIOS.rol, USUARIOS.apellido, USUARIOS.avatar
    ...
    WHERE IMAGENES.id_usuario = $userId
    ...
    <main >
        <div class="container mt-5" >
            <h1 class="text-center mb-4 display-5 fw-bold">
                <i class="fa-regular fa-images me-2"></i>Mis imagenes
            </h1>
            <div class="row">
                        ...
                        <div class="col">
                            <div class="card h-100 shadow-sm">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <a href="../funciones/eliminarimagen.php?id_imagen=<?php echo $imagen['id']; ?>&eliminar=true" class="btn btn-outline-danger w-100 mt-3">
