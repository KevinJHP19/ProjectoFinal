...
if(isset($_POST['nombre']) && isset($_POST['apellido']) && isset($_POST['usuario']) && isset($_POST['email'])) {
    ...
    $stmt->bind_param("sssssi", $nombre, $apellido, $usuario, $email, $avatar, $_SESSION['user_id']);
        ...
        <div class="container">
            ...
            <div class="bg-white border p-4 rounded-3">
                <div class="d-flex justify-content-between  align-items-center">
                    ...
                    <img src="../<?php echo $_SESSION['user_avatar'] ?>" alt="" class="img-fluid rounded-circle me-3" width="120px" height="120px" data-bs-toggle="modal" data-bs-target="#verImagenModal">
                        <div  class="d-flex flex-column">
                            <h7><?php echo $_SESSION['user_name'] . " ".$_SESSION['user_subname'] ?></h7>
                            <h7><em>@<?php  echo $_SESSION['user_nickname']?></em></h7>
                        </div>
                    </div>
                    <div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-6 p-3">
                            ...
                            <input type="text" id="name" class="form-control" disabled placeholder="<?php  echo $_SESSION['user_name']?>">
                        </div>
                        <div class="col-6 p-3">
                            <label for="apellido" class="form-label">Apellidos:</label>
                            <input type="text" id="apellido" class="form-control" disabled placeholder="<?php  echo $_SESSION['user_subname']?>">
                        </div>
                        <div class="col-6 p-3">
                            <label for="usuario" class="form-label">Usuario:</label>
                            <input type="text" id="usuario" class="form-control" disabled placeholder="<?php  echo $_SESSION['user_nickname']?>">
                        </div>
                        <div class="col-6 p-3" >
                            <label for="email" class="form-label">Correo electrónico:</label>
                            <input type="email" id="email" class="form-control" disabled placeholder="<?php  echo $_SESSION['user_email']?>">
                        </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="POST" enctype="multipart/form-data" action="editar_perfil.php">
          <label for="avatar" class="form-label">Avatar actual:</label>
            <div class="text-center">
            
            <img src="../<?php echo $_SESSION['user_avatar'] ?>" alt="" class="img-fluid rounded-circle mb-3" width="120px" height="120px">
            </div>
            <div class="mb-3">
              <label for="modalName" class="form-label">Nombres:</label>
              <input type="text" class="form-control" id="modalName" value="<?php echo $_SESSION['user_name']?>" required>
            </div>
            <div class="mb-3">
              <label for="modalApellido" class="form-label">Apellidos:</label>
              <input type="text" class="form-control" id="modalApellido" value="<?php echo $_SESSION['user_subname']?>" required>
            </div>
            <div class="mb-3">
              <label for="modalUsuario" class="form-label">Usuario:</label>
              <input type="text" class="form-control" id="modalUsuario" value="<?php echo $_SESSION['user_nickname']?>" required> 
            </div>
            <div class="mb-3">
              <label for="modalEmail" class="form-label">Correo electrónico:</label>
              <input type="email" class="form-control" id="modalEmail" required value="<?php echo $_SESSION['user_email']?>">
            </div>
