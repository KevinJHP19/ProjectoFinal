<header>
    ...
    <?php else: ?>
        ...
        <div class="dropdown d-none d-lg-block">
            <a class="bg-dark text-white dropdown-toggle d-flex align-items-center" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                <img src="<?php echo $_SESSION['user_avatar'] ?>" alt="" class="rounded-circle" width="40px" height="40px">
                <span class="ms-2 d-none d-lg-inline"><?php echo $_SESSION['user_nickname'] ?></span>
            </a>
            <ul class="dropdown-menu dropdown-menu-end">
                <li><a class="dropdown-item" href="#">Rol: <?php echo $_SESSION['user_rol'] ?></a></li>
        ...
        <div class="d-block d-lg-none text-white">
            ...
            <ul class="list-unstyled">
                <li>Rol: <?php echo $_SESSION['user_rol'] ?></li>
                <li><a href="./" class="mt-2 text-white nav-link">Mis me gusta</a></li>
                <li><a href="./usuario/perfil.php" class=" mt-32 text-white nav-link">Perfil</a></li>
                <li><a href="" class=" mt-2 text-white nav-link">Subir imagenes</a></li>
